...
- [Mass Matter Import](project_mass-matter-import.md): bulk-import Higgs matters/records; build in repo/ as a console command; setManager grants no access-role (the #1 gotcha)
