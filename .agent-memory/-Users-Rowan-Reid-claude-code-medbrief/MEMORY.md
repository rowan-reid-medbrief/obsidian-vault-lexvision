...
- [MedBrief dev environment bridge](project_medbrief_dev-environment.md) — Mutagen-synced local clone ↔ DigitalOcean VM, avoids manual SSH
- [MedBrief dev VM access](reference_medbrief_vm-access.md) — SSH/ZeroTier details for rowan-dev.medbrief.net
- [MRI-134 branch context](project_mri-134-branch.md) — feature/MRI-134-page-subset-extraction tracks Deon's Apryse viewer ask; full plan in sibling project
