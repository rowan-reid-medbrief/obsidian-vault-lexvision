...
- **MedBrief governance portal + AI-tooling data policy** - done 2026-07-24: extracted the internal governance portal (70 policies mirrored, indexed, gap-checked) and wrote a citation-backed synthesis on AI use on customer data; Confluence follow-up surfaced the GitHub Copilot vs Claude Enterprise board decision. [[2026-07-24-medbrief-governance-portal-and-ai-tooling-research]]
